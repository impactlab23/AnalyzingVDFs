...
Ordinal3_single_sim <- function(n_sample,        #trial sample size
  ...
  tryCatch({
    ...
    result_OO3 <- inla(VFD_OO_3 ~ treatment, 
                       ...
                       family = "pom",
                       lincomb = lc,
                       control.fixed = list(mean= 0, prec= 0.1),control.family = list(hyper = list(theta1 = list(param = 100))),
...
write.csv(results, file = "/home/aheath/Ziming_Sim/Wei_ordinal3/Ordinal3_worsen_both.csv")
