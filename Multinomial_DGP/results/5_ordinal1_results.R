...
Ordinal1_noeffect <- read.csv("ordinal1_noeffect.csv")
Ordinal1_imp_both <- read.csv("ordinal1_imp_both.csv")
Ordinal1_imp_lib_worse_mort <- read.csv("ordinal1_imp_lib_worse_mort.csv")
Ordinal1_imp_mort_worse_lib <- read.csv("ordinal1_imp_mort_worse_lib.csv")
Ordinal1_worsen_both <- read.csv("ordinal1_worsen_both.csv")
Ordinal1_imp_lib_no_mort <- read.csv("ordinal1_imp_lib_no_mort.csv")
Ordinal1_imp_mort_no_lib <- read.csv("ordinal1_imp_mort_no_lib.csv")
...
sqrt(Ordinal1_1$post_p*(1 - Ordinal1_1$post_p)/nrow(Ordinal1_imp_mort_no_lib))[c(1,3,2,5,4,7,6)]
