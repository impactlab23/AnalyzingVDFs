...
multinomial_data_gen_diff_effect(1.0, 1.3)

ordinal1_single_sim <- function(OR_mort, OR_lib){
...
Sim_Res <- foreach(k = 1:n_sim, .combine = rbind,
  ...
  set.seed(k + 5125)
  ordinal1_single_sim(OR_mort = 1.25,
                      OR_lib = 0.75)     
}
#stopCluster(cl)
...
write.csv(results, file = "C:/Users/Anna Heath/OneDrive/OneDrive - SickKids/Admin Anna/Hiring and Staff/Ziming Chen 2022/PRACTICAL/SimulationMar20/Multinomial_AH/ordinal1/ordinal1_imp_lib_worse_mort.csv")
