...
write.csv(results, file = "C:/Users/Anna Heath/OneDrive/OneDrive - SickKids/Admin Anna/Hiring and Staff/Ziming Chen 2022/PRACTICAL/SimulationMar20/Multinomial_AH/ordinal3/ordinal3_imp_mort_no_lib.csv")

#save.image(file = "/home/aheath/Ziming_Sim/ordinal3/ordinal3_imp_mort_no_lib.Rdata")