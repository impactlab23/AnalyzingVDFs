...
write.csv(results, file = "/home/aheath/Ziming_Sim/BS1/BS1_imp_lib_no_mort.csv")

save.image(file = "/home/aheath/Ziming_Sim/BS1/BS1_imp_lib_no_mort.Rdata")
