...
write.csv(results, file = "/home/aheath/Ziming_Sim/BS2/BS2_imp_mort_worse_lib.csv")

save.image(file = "/home/aheath/Ziming_Sim/BS2/BS2_imp_mort_worse_lib.Rdata")
