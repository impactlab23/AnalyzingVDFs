...
write.csv(results, file = "/home/aheath/Ziming_Sim/BS2/BS2_imp_lib_no_mort.csv")

save.image(file = "/home/aheath/Ziming_Sim/BS2/BS2_imp_lib_no_mort.Rdata")
