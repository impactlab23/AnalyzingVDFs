...
setwd("C:/Users/Ziming Chen/OneDrive - SickKids/PRACTICAL/NewSims/Multinomial/hurdle")
...
hurdle_1 <- data.frame(scenario = c("no_eff", "worsen_both", "imp_both", "worsen_mort_imp_lib", "worsen_lib_imp_mort", "imp_lib_no_mort", "imp_mort_no_lib"),
                       post_p = c(0.05, hurdle_post_p_worsen_both, hurdle_post_p_imp_both, hurdle_post_p_imp_lib_worse_mort, hurdle_post_p_imp_mort_worse_lib, hurdle_post_p_imp_lib_no_mort, hurdle_post_p_imp_mort_no_lib),
